    ...
    public function get($transactionId)
    {
        ...
        if ($transaction){
            $good= Db::name('goods')
                ...
                ->field('g.goods_id, g.isresale, g.isgive, g.goods_name,g.stock_total,g.update_time,g.xn_sale,g.goods_price_min,g.status,uf.file_path,g.content,gs.stock_num,g.startTime,g.author,g.goods_address,g.logo,uf.file_id')
                ->find();
