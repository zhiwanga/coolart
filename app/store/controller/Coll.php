...
class Coll extends Controller
{
    ...
    public function lista(){
        ...
        return $this->renderSuccess(compact('coll_list'));
    ...
    public function ktlist(){
        ...
        $coll_list = CollModel::alias('c')
            ->field('c.coll_id,c.addtime,c.user_id,c.goods_id')
            ->field('yu.mobile')
            ->field('yg.goods_name')
            ->where('c.is_give',0)
            ->where('c.type',2)
    ...
    public  function export()
    {
        ...
        return $this->renderSuccess(['url'=>$filePath . $fileName]);
    }
