...
class DES
{
    ...
    public function encrypt($str)
    {
        ...
        $sign = openssl_encrypt($str, $this->method, $this->key, intval($this->options), $this->iv);
    ...
    public function decrypt($encrypted)
    {
        ...
        $sign = @openssl_decrypt($encrypted, $this->method, $this->key, intval($this->options), $this->iv);
